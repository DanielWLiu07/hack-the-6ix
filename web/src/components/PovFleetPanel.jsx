...
// PovFleetPanel - the cockpit's mission-control sidebar: a live fleet roster on
// top (click a rover to "enter" it in POV) and the FarmHand NL command console
// below. Roster is the live `fleet` event; the console owns nl_command/nl_action
// (broadcast to the fleet - the real robot executes, sim rovers stand in). No
// mock data. Purely presentational; the parent (RobotPOV) owns fleet + selection.
