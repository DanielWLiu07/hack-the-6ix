// Light validators for the docs/SCHEMAS.md event schemas. Required fields must
...
export const validators = {
  ...
  // SLAM occupancy map (docs/SCHEMAS.md addendum). base64 uint8
  ...
  // SLAM pose (docs/SCHEMAS.md addendum). theta in radians.
  slam_pose: (p) =>
